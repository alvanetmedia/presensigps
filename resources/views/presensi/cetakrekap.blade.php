...
<body class="A4 landscape">
    ...
    <section class="sheet padding-10mm">
            ...
            <tr>
                ...
                <td>
                    <span id="title">
                        ...
                        KPU KABUPATEN BANDUNG BARAT<br>
                    </span>
                    <span><i>Jl. Raya Purwakarta No.430, Tagogapu, Kec. Padalarang, Kabupaten Bandung Barat, Jawa Barat 40553</i></span>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="margin-top:100px">
            <tr>
                <td></td>
                <td style="text-align: center">Padalarang, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
                <td style="text-align: center; vertical-align:bottom" height="100px">
                    <u>Wendi Firmansyah</u><br>
                    <i><b>HRD Manager</b></i>
                </td>
